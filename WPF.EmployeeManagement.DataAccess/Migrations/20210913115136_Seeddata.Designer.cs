...
namespace WPF.EmployeeManagement.DataAccess.Migrations
{
    ...
    [Migration("20210913115136_Seeddata")]
            ...
            modelBuilder.Entity("WPF.EmployeeManagement.Model.Model.Meeting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MeetingID = 1,
                            EndDate = new DateTime(2021, 9, 13, 13, 51, 36, 178, DateTimeKind.Local).AddTicks(8683),
                            StartDate = new DateTime(2021, 9, 13, 13, 51, 36, 176, DateTimeKind.Local).AddTicks(2429),
                            Title = "Rum 1"
                        },
                        new
                        {
                            MeetingID = 2,
                            EndDate = new DateTime(2021, 9, 13, 13, 51, 36, 178, DateTimeKind.Local).AddTicks(8964),
                            StartDate = new DateTime(2021, 9, 13, 13, 51, 36, 178, DateTimeKind.Local).AddTicks(8956),
                            Title = "Rum 2"
                        });
                });
